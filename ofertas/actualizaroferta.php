                    ...
                    <div class="row">
                        ...
                        <div class="col-md-5 mb-3">
                            ...
                            <?php
                                require_once("../php/actualizaroferta.php");
                                foreach ($oferta as $key => $datos) {
                                    print "<option class='text-info text-uppercase' value=".$datos['idprod']." disabled selected>".$datos['prod']." - ".$datos['codpr']."</option>";
                                }
                            ?>
                            <?php
                        ...
                        <div class="col-md-2 mb-3">
                            ...
                            <?php
                                require_once("../php/actualizaroferta.php");
                                foreach ($oferta as $key => $datos) {
                                    print "<option class='text-capitalize' value=".$datos['unt']." disabled selected>".$datos['unt']."</option>";
                                }
                            ?>
